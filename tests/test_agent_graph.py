...
def test_demand_side_fz_branches_mapped():
    ...
    # Волна 3 (Роль 3, 2026-07-13): +18 бытовых актов, тот же плоский 1:1.
    pairs.update({
        "микрозаймы": "Закон о микрофинансовой деятельности",
        "обращение с животными": "Закон об обращении с животными",
        "платёжные системы": "Закон о национальной платёжной системе",
        "противодействие отмыванию доходов": "Закон о противодействии отмыванию доходов",
        "полиция": "Закон о полиции",
        "воинская обязанность": "Закон о воинской обязанности",
        "больничные и декретные": "Закон о пособиях по нетрудоспособности",
        "самозанятые": "Закон о самозанятых",
        "кредитные истории": "Закон о кредитных историях",
        "социальная защита инвалидов": "Закон о социальной защите инвалидов",
        "воздушные перевозки": "ВК РФ",
        "туризм": "Закон о туристской деятельности",
        "нотариат": "Основы законодательства о нотариате",
        "информация": "Закон об информации",
        "реклама": "Закон о рекламе",
        "государственная социальная помощь": "Закон о государственной социальной помощи",
        "ветераны": "Закон о ветеранах",
        "регистрация юрлиц и ип": "Закон о регистрации юрлиц и ИП",
    })
...
def test_keyword_acts_unit():
    ...
    # Волна 3: микрозаём ведём и в спец-закон МФО, и в общий потребкредит.
    assert keyword_acts("взял микрозайм под конский процент") == [
