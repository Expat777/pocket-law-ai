...
**Дальше:** точка И2 (переключение на боевую `law_articles`), запись версий в `law_versions` после миграций Роли 4. Задел на другие кодексы: проверены nd в ИПС — УК `102041891`, ГК ч.1/3/4 `102033239`/`102073578`/`102110716` (КоАП и ГК ч.2 — уточнить). Пока решили ограничиться ТК РФ.
